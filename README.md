...
The web pages are all directly from the WLED project.  Note that I have not tested this using a virtual environment. I've included this as a submodule  After cloning the repo, you should be able to run 
