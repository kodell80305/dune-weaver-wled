effects_list2 = [
    ...
    },
    {
        'ID': '102',
        'Effect': 'Candle Multi',
        'Description': 'Like candle effect, but each LED has its own flicker pattern',
        'Colors': 'None',
        'Parms': 'None'
    },
    {
    ...
    },
    {
        'ID': '155',
        'Effect': 'Freqmap',
        'Description': 'Map the loudest frequency throughout the length of the LEDs.',
        'Colors': 'None',
        'Parms': 'None'
    },
    {
    ...
    },
    {
        'ID': '107',
        'Effect': 'Noise Pal',
        'Description': 'Peaceful noise thats slow and with gradually changing palettes',
        'Colors': 'None',
        'Parms': 'None'
    },
    {
    ...
    {
        'ID': '166',
        'Effect': 'Sun Radiation',
        'Description': 'The sun! Doesnt support segments.',
        'Colors': 'None',
        'Parms': 'None'
    },
    {
    ...
    },
    {
        'ID': '184',
        'Effect': 'Wavesins',
        'Description': 'Beat waves and phase shifting. Looks OK in 2Dish as well.',
        'Colors': 'None',
        'Parms': 'None'
    },
    {
